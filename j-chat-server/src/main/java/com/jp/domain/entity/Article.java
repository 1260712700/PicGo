...
public class Article implements BaseData {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getArticleImages() == null ? other.getArticleImages() == null : this.getArticleImages().equals(other.getArticleImages()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getArticleImages() == null) ? 0 : getArticleImages().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", articleImages=").append(articleImages);
