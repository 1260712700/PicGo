<template>
    ...
    <button ref="darkModeRef" @click="TOGGLE"  class="toggle" aria-pressed="false" >
      ...
      <path fill="url(#b)" fill-opacity=".4" fill-rule="evenodd" d="M709.7 164.481c-17.939 14.394-28.018 37.148-28.018 57.504h61.648c.087-13.669 11.194-24.723 24.883-24.723h18.56c13.689 0 24.796 11.054 24.883 24.723H873c0-20.356-10.078-43.11-28.018-57.504C827.043 150.086 802.711 142 777.341 142c-25.37 0-49.701 8.086-67.641 22.481Z" clip-rule="evenodd"/>
      ...
      <path fill="#D9D9D9" stroke="#000" stroke-width="6" d="M795 370h-28v16h28zm76-69h-16v95h16zm-172 0h-16v95h16z"/>
      <rect width="74.266" height="52" x="-3" y="3" fill="#AF7128" stroke="#000" stroke-width="6" rx="26" transform="matrix(-1 0 0 1 732 316)"/>
      ...
      <path fill="#6FB7D6" fill-opacity=".53" d="M415 372.657 643.398 213v159.657H415Z"/>
      <path fill="url(#c)" fill-opacity=".4" d="M415 372.657 643.398 213v159.657H415Z"/>
      ...
      <ellipse cx="59.871" cy="539.966" fill="url(#d)" rx="59.871" ry="38.806"/>
      <path fill="#5B5B5B" d="M106.438 441.29h53.219v199.571h-53.219z"/>
      <path fill="#D9D9D9" fill-rule="evenodd" d="M1359.3 372.549H159.657v337.053H949.06l410.24-236.853v-100.2Z" clip-rule="evenodd"/>
      <path fill="url(#e)" fill-opacity=".4" fill-rule="evenodd" d="M1359.3 372.549H159.657v337.053H949.06l410.24-236.853v-100.2Z" clip-rule="evenodd"/>
      <path fill="url(#f)" d="M281.617 408.028h263.877v263.877H281.617z"/>
      <path fill="#FF0B0B" d="M192.919 709.602h443.492V798.3H192.919z"/>
      <path fill="url(#g)" fill-opacity=".3" d="M192.919 709.602h443.492V798.3H192.919z"/>
      <path fill="#FF0B0B" d="M192.919.016h443.492v88.698H192.919z"/>
      <path fill="url(#h)" fill-opacity=".28" d="M192.919.016h443.492v88.698H192.919z"/>
      <path fill="#FF0B0B" d="M1175.25 396.941h221.746v44.349H1175.25z"/>
      <path fill="url(#i)" fill-opacity=".2" d="M1175.25 396.941h221.746v44.349H1175.25z"/>
      <path fill="#F20000" d="M1301.65 212.892H1448l-90.92 159.657h-148.57l93.14-159.657Z"/>
      <path fill="url(#j)" fill-opacity=".2" d="M1301.65 212.892H1448l-90.92 159.657h-148.57l93.14-159.657Z"/>
          ...
          <span class="astrobear">
            ...
            <svg aria-hidden=true xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 316 432">
              ...
              <defs>
                ...
                <radialGradient id="cc" cx="0" cy="0" r="1" gradientTransform="matrix(165.9998 58.9999 -60.6938 170.7657 210 171)" gradientUnits="userSpaceOnUse">
...
const settingStore= useSettingStore()
  ...
  onMounted(()=>{
    const BUTTON = darkModeRef.value
    BUTTON.setAttribute("aria-pressed", settingStore.darkModeSwitch ? true : false);
  })
  
  const TOGGLE = () => {
  const BUTTON = darkModeRef.value
    let IS_PRESSED = settingStore.darkModeSwitch;
    BUTTON.setAttribute("aria-pressed", IS_PRESSED ? false : true);
    settingStore.darkModeSwitch=!IS_PRESSED;
    const application=document.querySelector('#application')
    application.className=!IS_PRESSED?'dark':'light'
  };
  </script>
  <style>
